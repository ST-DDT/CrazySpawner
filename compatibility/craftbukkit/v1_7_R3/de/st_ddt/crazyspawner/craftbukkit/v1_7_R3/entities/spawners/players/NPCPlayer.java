...
final class NPCPlayer extends EntityPlayer
{
	...
	private static ItemStack[] getLiving_g(final EntityLiving living)
	{
		...
		{
			System.err.println("[CrazySpawner_1_7_R3] WARNING: Serious Bug detected, please report this!");
			e.printStackTrace();
			return null;
		}
	}
	...
	@Override
	// Copied from net.minecraft.server.v1_7_R3.EntityLiving.
	...
	// Copied from net.minecraft.server.v1_7_R3.EntityLiving.h()
	@Override
	public void h()
	{
		super.h();
		if (!this.world.isStatic)
		{
			...
			for (int j = 0; j < 5; j++)
			{
				...
				if (!ItemStack.matches(itemstack1, itemstack))
				{
					...
					if (itemstack != null)
						// this.d => net.minecraft.server.v1_7_R3.EntityLiving.bb()
