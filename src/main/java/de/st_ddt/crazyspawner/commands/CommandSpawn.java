...
public class CommandSpawn extends CommandExecutor
{
	...
	public void command(final CommandSender sender, final String[] args) throws CrazyException
	{
		...
		if (!(sender.hasPermission("crazyspawner.spawn.*") || sender.hasPermission("crazyspawner.spawn." + spawner.getEntityType().name() + ".*") || sender.hasPermission("crazyspawner.spawn." + spawner.getName())))
